const baseUrl = "https://deinusername.github.io/dein-repo-name";
...
function setupHost() {
  ...
  document.getElementById("generatedLinks").innerHTML = `
    ...
    <p><strong>Abstimmen:</strong> <a href="${voteLink}" target="_blank">${voteLink}</a></p>
    <p><strong>Ergebnisse:</strong> <a href="${resultLink}" target="_blank">${resultLink}</a></p>
  `;
}
